...
class NotifyCSingle():
    ...
    def setIVBounds(self,newIBounds,newVBounds):
        ...
        self.I_bounds = newIBounds
        self.V_bounds = newVBounds
        return
...
def ps_monitorSingle(ps,Notify,
                     V_set,I_set,
                     ps_checking_interval,infuseInterval,infuseRate,notifyIntervalMin):
    """
...
def menu():
    ...
    NotifyObject = NotifyCSingle(SID,AUTH,TO_NUM,FROM_NUM,my_email,[0.02,18],[0.01,1],error_notify_interval_def,
